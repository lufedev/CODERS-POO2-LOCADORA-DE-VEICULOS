...
public class ClienteController extends ClienteEmMemoriaRepository {
    protected static void alterarInfos(Cliente cliente) {
        ...
        switch (escolha) {
            case "1":
                cliente.setNome(ConsoleUIHelper.askSimpleInput("Digite o nome: "));
                break;
            case "2":
                cliente.setDocumento(ConsoleUIHelper.askSimpleInput("Digite o Documento: "));
                break;
            case "3":
    ...
    protected static TipoCliente cadastrarTipoCliente() {
        ...
        TipoCliente tipoCliente = (resposta == 1) ? new TipoCliente("Pessoa Fisica", BigDecimal.valueOf(5), 5) : new TipoCliente("Pessoa Juridica", BigDecimal.valueOf(10), 3);
        return tipoCliente;
    }
