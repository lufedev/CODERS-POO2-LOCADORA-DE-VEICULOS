    ...
    public void menuClientes(Scanner sc) {
        ...
        do {
            ...
            switch (menu) {
                case "1":
                    do {
                        Cliente cliente = cr.cadastrarCliente(ConsoleUIHelper.askConfirm("Deseja fazer o cadastro completo do cliente ou cadastro rapido?", "Sim, quero fazer o cadastro completo", "Não, quero fazer cadastro simples"));
                        cr.salvar(cliente);
                ...
                case "3":
                    do {
                        if (!cr.getEntidades().isEmpty()) {
                            cr.buscarPeloNome(ConsoleUIHelper.askSimpleInput("Digite o nome ou parte do nome para fazer a busca:")).forEach(System.out::println);
                        } else System.out.println("lista de clientes esta vazia");
